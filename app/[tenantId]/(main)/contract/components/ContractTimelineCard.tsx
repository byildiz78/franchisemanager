...
import { ContractActivity } from "../contract-types"
...
export function ContractTimelineCard({ activities }: ContractTimelineCardProps) {
  ...
  const getActivityColor = (type: ContractActivity["type"]) => {
    switch (type) {
      case "comment":
