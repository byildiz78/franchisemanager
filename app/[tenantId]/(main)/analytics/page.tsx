...
export default function AnalyticsPage() {
    return (
        <div className="flex flex-col h-[calc(100vh-4rem)] bg-gradient-to-br from-gray-50 to-gray-100/50">
            <div className="flex-1 p-4 md:p-8 pt-6 overflow-hidden">
                ...
                <Card className="overflow-hidden border-none shadow-md bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/80 h-[calc(100vh-12rem)]">
                    <Tabs defaultValue="adaylar" className="h-full flex flex-col">
                        <div className="flex-none border-b bg-white/50">
                        ...
                        <div className="flex-1 overflow-hidden">
                            <TabsContent 
                                value="adaylar" 
                                className="h-full overflow-y-auto px-4 pb-8 pt-4 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300"
                            >
                                <AdaylarDashboard />
                            </TabsContent>
                            <TabsContent 
